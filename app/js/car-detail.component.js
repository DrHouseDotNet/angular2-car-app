System.register(["angular2/core", "./car-service", "angular2/router"], function(exports_1) {
    ...
    var core_1, car_service_1, router_1;
        ...
        execute: function() {
            CarDetailComponent = (function () {
                ...
                CarDetailComponent.prototype.ngOnInit = function () {
                    ...
                    this._carService.getCar(id).subscribe(function (data) { return _this.car = data; }, function (error) { return console.log(error); });
                };
